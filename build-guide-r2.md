...
1. PCB
2. ProMicro
3. Headers for ProMicro
4. 60 1N4148 Diodes
5. 330ohm Resistor
6. 22pF Capacitor
7. Reset Button
8. Inidicator LED
9. Acrylic Switch Plate
...
3. Isopropyl Alcohol (optional, for cleaning solder-flux residue)
...
## 3. Plate, Stabilizer, Switches
1. Install the stabilizer (if you have the MIT-Layout)
2. Place the acrylic plate over it.
3. Install/Solder the switches.


## 4. Case Assembly
Move on to [this](build-guide-r2-assembly.md) tutorial